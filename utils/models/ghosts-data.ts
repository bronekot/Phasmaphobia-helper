...
export const ghostsData: Readonly<Record<GhostId, Ghost>> = {
  [GhostId.Spirit]: {
    ...
    clues: [ClueId.EmfLevel5, ClueId.GhostWriting, ClueId.SpiritBox, ClueId.DisturbedSaltPile],
  },
  [GhostId.Wraith]: {
    id: GhostId.Wraith,
    label: 'Мираж',
    ...
    clues: [ClueId.EmfLevel5, ClueId.SpiritBox, ClueId.DotsProjector],
  },
  [GhostId.Phantom]: {
    id: GhostId.Phantom,
    label: 'Фантом',
    ...
    clues: [ClueId.Ultraviolet, ClueId.SpiritBox, ClueId.DotsProjector, ClueId.DisturbedSaltPile],
  },
  [GhostId.Poltergeist]: {
    ...
    clues: [ClueId.GhostWriting, ClueId.Ultraviolet, ClueId.SpiritBox, ClueId.DisturbedSaltPile],
  },
  [GhostId.Banshee]: {
    id: GhostId.Banshee,
    label: 'Банши',
    ...
    clues: [ClueId.Ultraviolet, ClueId.GhostOrb, ClueId.DotsProjector, ClueId.DisturbedSaltPile],
  },
  [GhostId.Jinn]: {
    id: GhostId.Jinn,
    label: 'Джинн',
  ...
  [GhostId.Mare]: {
    ...
    clues: [ClueId.GhostWriting, ClueId.SpiritBox, ClueId.GhostOrb, ClueId.DisturbedSaltPile],
  },
  [GhostId.Revenant]: {
    id: GhostId.Revenant,
    label: 'Ревенант',
  ...
  [GhostId.Yokai]: {
    ...
    clues: [ClueId.SpiritBox, ClueId.GhostOrb, ClueId.DotsProjector, ClueId.DisturbedSaltPile],
  },
  [GhostId.Hantu]: {
    id: GhostId.Hantu,
    label: 'Ханту',
  ...
  [GhostId.Goryo]: {
    ...
    clues: [ClueId.EmfLevel5, ClueId.Ultraviolet, ClueId.DotsProjector, ClueId.DisturbedSaltPile],
  },
  [GhostId.Myling]: {
    id: GhostId.Myling,
    label: 'Мюлинг',
    ...
    clues: [ClueId.EmfLevel5, ClueId.GhostWriting, ClueId.Ultraviolet, ClueId.DisturbedSaltPile],
  },
  [GhostId.Onryo]: {
    id: GhostId.Onryo,
    label: 'Онрё',
  ...
  [GhostId.Raiju]: {
    ...
    clues: [ClueId.EmfLevel5, ClueId.GhostOrb, ClueId.DotsProjector, ClueId.DisturbedSaltPile],
  },
  [GhostId.Obake]: {
    id: GhostId.Obake,
    label: 'Обакэ',
    ...
    clues: [ClueId.EmfLevel5, ClueId.Ultraviolet, ClueId.GhostOrb, ClueId.DisturbedSaltPile],
  },
  [GhostId.TheMimic]: {
    id: GhostId.TheMimic,
    label: 'Мимик',
  ...
  [GhostId.Deogen]: {
    ...
    clues: [ClueId.SpiritBox, ClueId.DotsProjector, ClueId.GhostWriting, ClueId.DisturbedSaltPile],
  },
  [GhostId.Thaye]: {
    id: GhostId.Thaye,
    label: 'Тайэ',
    ...
    clues: [ClueId.GhostWriting, ClueId.GhostOrb, ClueId.DotsProjector, ClueId.DisturbedSaltPile],
  },
};
